...
public final class Http2Stream {
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f1419id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.f1419id, true, (okio.Buffer) null, 0);
         */
                ...
                synchronized (Http2Stream.this) {
                    ...
                    if (!this.closed) {
                        ...
                        if (errorCode == null && Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                            Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f1419id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    class StreamTimeout extends AsyncTimeout {
        ...
        public IOException newTimeoutException(IOException iOException) {
            SocketTimeoutException socketTimeoutException = new SocketTimeoutException(SharePreManager.SHARE_TIMEOUT);
            if (iOException != null) {
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f1419id);
            return true;
        }
    }
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f1419id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f1419id, errorCode2);
        }
    }
    ...
    public boolean isLocallyInitiated() {
        return this.connection.client == ((this.f1419id & 1) == 1);
    }
    ...
    public void sendResponseHeaders(List<Header> list, boolean z) throws IOException {
        ...
        if (list != null) {
            ...
            this.connection.writeSynReply(this.f1419id, z3, list);
            if (z2) {
