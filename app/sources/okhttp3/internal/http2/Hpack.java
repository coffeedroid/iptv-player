...
final class Hpack {
    ...
    static final class Reader {
        ...
        public ByteString readByteString() throws IOException {
            ...
            return z ? ByteString.m1223of(Huffman.get().decode(this.source.readByteArray((long) readInt))) : this.source.readByteString((long) readInt);
        }
