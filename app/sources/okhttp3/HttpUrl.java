        ...
        public Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                if (i5 < i4) {
                    ...
                    if (this.port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i5, i4) + Typography.quote);
                    }
                } else {
                    this.host = canonicalizeHost(str2, i2, portColonOffset);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i2, portColonOffset) + Typography.quote);
                }
            } else {
