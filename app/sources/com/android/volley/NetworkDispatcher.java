...
public class NetworkDispatcher extends Thread {
    ...
    public void processRequest(Request<?> request) {
        ...
        try {
            ...
            VolleyLog.m886e(e2, "Unhandled exception %s", e2.toString());
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m885e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
}
