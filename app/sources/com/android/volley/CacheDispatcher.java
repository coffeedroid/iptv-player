...
public class CacheDispatcher extends Thread {
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        public synchronized boolean maybeAddToWaitingRequests(com.android.volley.Request<?> r6) {
            ...
            L_0x001e:
                ...
                com.android.volley.VolleyLog.m884d(r6, r1)     // Catch:{ all -> 0x0052 }
            L_0x0038:
                monitor-exit(r5)
                return r2
            L_0x003a:
        ...
        public synchronized void onNoUsableResponseReceived(Request<?> request) {
            ...
            if (remove != null && !remove.isEmpty()) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m887v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), cacheKey);
                }
                ...
                try {
                    ...
                    VolleyLog.m885e("Couldn't add request to queue. %s", e.toString());
        ...
        public void onResponseReceived(Request<?> request, Response<?> response) {
            ...
            if (remove != null) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m887v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), cacheKey);
                }
    ...
    public void run() {
        if (DEBUG) {
            VolleyLog.m887v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                VolleyLog.m885e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
}
